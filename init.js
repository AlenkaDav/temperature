$.init = function(_n, _time, _T1, _T2, _Length, _Radius, _Circle, _alfa,h){
	//n = ; //40
	//time = 20;
	//Length = 100;
	//T1 = 100;
	...
	//r = new Vector;
	//r = direction;
	T_ = $.InstantTemperature(_n,_time,_Length,_T1,_T2,direction,detalisation,l,w,_Radius,_Circle,h);
